...
js-test: ts-check
	node --test ./server/js/room/*.test.ts ./server/js/room/model/*.test.ts ./server/js/room/modes/*.test.ts ./server/js/room/gl/*.test.ts ./server/js/room/render/*.test.ts ./server/js/room/render/stages/*.test.ts

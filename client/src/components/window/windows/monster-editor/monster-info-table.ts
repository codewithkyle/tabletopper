        ...
        const view = html`
            ...
            ${this.model.rows.map((row, index) => {
                return html`
                    <table-row>
                        <row-title>
                            <input name="${this.model.name}-${index}" required value="${row.name}" placeholder="Name" @input=${this.updateName} data-index="${index}">
                        ...
                        <textarea name="${this.model.name}-${index}" required placeholder="Description" rows="4" @input=${this.updateDesc} data-index="${index}">${row.desc}</textarea>
                    </table-row>
                `;
            })}

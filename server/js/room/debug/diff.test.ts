...
test("an ordered slice reports the position that differs", () => {
	const [mine, theirs] = pair();
	mine.table.layers = [
		{ id: "one", name: "Ground", map: null, gmMap: null, fogEnabled: false, fogPrefill: false, partyStart: null },
		{ id: "two", name: "Upper", map: null, gmMap: null, fogEnabled: false, fogPrefill: false, partyStart: null },
	];

import{subscribe as u}from"./pubsub.js";import{navigateTo as c}from"./router.js";import h from"./supercomponent.js";import{render as g,html as t}from"./lit-html.js";import o from"./button.js";import d from"./input.js";import b from"./spinner.js";import w from"./env.js";import f from"./notifications.js";import m from"./control-center.js";import v from"./disk-jockey.js";import{connected as k,send as s}from"./ws.js";import a from"./homepage-music-player.js";import y from"./player-token-picker.js";class x extends h{constructor(){super(),this.state="WELCOME",this.stateMachine={WELCOME:{NEXT:"MENU"},MENU:{JOIN:"ROOM"},ROOM:{NEXT:"CHARACTER",BACK:"MENU"},CHARACTER:{BACK:"ROOM"}},this.model={connected:k,code:""},sessionStorage.getItem("kicked")&&(f.error("Kicked From Game","You have been kicked by the Game Master."),sessionStorage.removeItem("kicked")),u("socket",this.inbox.bind(this))}inbox({type:e,data:r}){switch(e){case"connected":this.model.connected||this.set({connected:!0});break;case"disconnected":this.model.connected&&this.set({connected:!1});break;case"room:join":c(`/room/${r.code}`),v.pause("mainMenu");break;case"character:getDetails":this.trigger("NEXT");break;default:break}}async connected(){await w.css(["homepage"]),this.render()}renderActions(){return t`
